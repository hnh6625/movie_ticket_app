...
--
-- Class Concession as table concessions
--
...
--
-- Class OrderConcession as table order_concessions
--
...
--
-- Class OrderSeat as table order_seats
--
...
--
-- Class ShowtimeSeat as table showtime_seats
--
...
--
-- Class Showtime as table showtimes
--
...
-- Indexes
CREATE UNIQUE INDEX "user_profile_identifier_unique_idx" ON "user_profiles" USING btree ("userIdentifier");
...
--
-- Foreign relations for "order_concessions" table
--
...
--
-- Foreign relations for "order_seats" table
--
...
--
-- Foreign relations for "seats" table
--
...
--
-- Foreign relations for "showtime_seats" table
--
...
--
-- Foreign relations for "showtimes" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('movie_ticket_app', '20260731040921549', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260731040921549', "timestamp" = now();
